<template>
  <div class="content">
    <div class="top-family">
      <router-link class="iconfont icon-leftn" to="/course" tag="i"></router-link>
      <p>家庭教育</p>
      <span></span>
    </div>
    <ul class="family-2">
      <li class="family-2-1" v-for="item of prolist" :key="item.id">
        <div class="family-img">
          <img :src="item.images.small" alt="">
        </div>
        <div class="family-2-2">
          <p>{{ item.title }}</p>
